...
class GameResourceTest {
    ...
    void shouldCreateAndStartGame() {
        var info = new ClassicGameCreationInfo("gid", "cube-123",
                List.of(
    ...
    void shouldGetDraftData() {
        var player = new ClassicPlayer("Alice", "acct-1", 0, List.of(), null, null);
        var data = new PlayerDraftData("game-456", ClassicGameState.GAME_STARTED, DraftDirection.ASCENDING, player);
